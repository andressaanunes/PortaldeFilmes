const dadosFilmes = {
    "results": [{
        ...
        "id": 671,
        "original_language": "en", "original_title": "Harry Potter and the Philosopher's Stone",
    ...
    },
    {
        ...
        "id": 767,
        "original_language": "en", "original_title": "Harry Potter and the Half-Blood Prince",
        ...
        "release_date": "2009-07-07", "title": "Harry Potter e o Enigma do Príncipe",
        "video": false,
        "vote_average": 7.7,
    },
    {
        ...
        "id": 672,
        "original_language": "en", "original_title": "Harry Potter and the Chamber of Secrets",
...
const mostraFilmes = (data) => {
    ...
    for (let i = 0; i < dadosFilmes.results.length; i++) {
        ...
        dadosHTML += `<div class="card col-4" >
        <img src="https://image.tmdb.org/t/p/w500${filme.poster_path}" widht="200px" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">${filme.title}</h5>
          <p class="card-text">${filme.overview}</p>
          <a href="detalhes_filme.html?id=${filme.id}" class="btn btn-primary">Ver Mais</a>
           </div>  
        </div>
        `
    }
...
let url = "https://api.themoviedb.org/3/movie/popular?api_key=e568974f0ba924ff14aeb80473243835&language=pt-BR&query=potter"
